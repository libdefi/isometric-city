...
export const TOOL_INFO: Record<Tool, ToolInfo> = {
  ...
  rail: { name: 'Rail', cost: 100, description: 'Build railway tracks' },
  ...
  rail_station: { name: 'Rail Station', cost: 1200, description: 'Train station (2x2)', size: 2 },
...
export const BUILDING_STATS: Record<BuildingType, { maxPop: number; maxJobs: number; pollution: number; landValue: number }> = {
  ...
  rail_station: { maxPop: 0, maxJobs: 20, pollution: 1, landValue: 30 },
