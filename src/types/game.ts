...
export const TOOL_INFO: Record<Tool, ToolInfo> = {
  ...
  rail: { name: 'Rail', cost: 35, description: 'Build rail tracks for trains' },
  ...
  rail_station: { name: 'Rail Station', cost: 800, description: 'Access to rail network', size: 1 },
...
export const BUILDING_STATS: Record<BuildingType, { maxPop: number; maxJobs: number; pollution: number; landValue: number }> = {
  ...
  rail: { maxPop: 0, maxJobs: 0, pollution: 1, landValue: 5 },
  ...
  rail_station: { maxPop: 0, maxJobs: 18, pollution: 0, landValue: 20 },
