...
export const TOOL_INFO: Record<Tool, ToolInfo> = {
  ...
  rail: { name: 'Rail', cost: 40, description: 'Lay rail tracks for trains' },
  ...
  rail_station: { name: 'Rail Station', cost: 1500, description: 'Train station for passenger and freight (2x2)', size: 2 },
...
export const BUILDING_STATS: Record<BuildingType, { maxPop: number; maxJobs: number; pollution: number; landValue: number }> = {
  ...
  rail_station: { maxPop: 0, maxJobs: 30, pollution: 2, landValue: 20 },
